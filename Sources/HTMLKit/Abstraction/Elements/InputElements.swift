...
extension OptionGroup: GlobalAttributes, GlobalEventAttributes, GlobalAriaAttributes, DisabledAttribute, LabelAttribute {
    ...
    public func title(_ localizedString: LocalizedString) -> OptionGroup {
    ...
    public func label(_ localizedString: LocalizedString) -> OptionGroup {
        return mutate(label: localizedString)
    }
...
extension Option: GlobalAttributes, GlobalEventAttributes, GlobalAriaAttributes, DisabledAttribute, LabelAttribute, ValueAttribute, SelectedAttribute {
    ...
    public func title(_ localizedString: LocalizedString) -> Option {
        return mutate(title: localizedString)
    }
    ...
    public func label(_ localizedString: LocalizedString) -> Option {
        return mutate(label: localizedString)
    }
    ...
    public func value(_ localizedString: LocalizedString) -> Option {
...
extension Legend: GlobalAttributes, GlobalEventAttributes, GlobalAriaAttributes {
    ...
    public func title(_ localizedString: LocalizedString) -> Legend {
        return mutate(title: localizedString)
    }
...
extension Summary: GlobalAttributes, GlobalEventAttributes, GlobalAriaAttributes {
    ...
    public func title(_ localizedString: LocalizedString) -> Summary {
        return mutate(title: localizedString)
    }
